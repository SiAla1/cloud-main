...
server = os.getenv('DB_SERVER', 'sqldbminiproject.database.windows.net')  # Nom du serveur Azure
database = os.getenv('DB_NAME', 'societe')  # Nom de la base de données
username = os.getenv('DB_USER', 'Sqladmin')  # Nom d'utilisateur
password = os.getenv('DB_PASSWORD', 'Ala12345')  # Mot de passe
